...
0. Solution file: https://github.com/hnvt1989/SpecFlowSelenium/blob/master/SeleniumTests.sln
...
3. At line 23 of the file : https://github.com/hnvt1989/SpecFlowSelenium/blob/master/SeleniumTests/TestBase.cs
Please update it to be the file path of the home.html page in your local workstation.
4. Implented with SpecFlow, Selenium with .Net, NUnit as testing framework and test runner + NUnit3TestAdapter, PageObject model (using PageFactory and attribute locators)
